...
const ProblemPage = () => {
  ...
  const mockProblems = [
    ...
    },
    {
      ...
      timeLimit: '2s',
      successRate: '38%',
      description: 'Find all words in a board from a given dictionary using a trie'
    },
    {
      id: 13,
    ...
    },
    {
      ...
      timeLimit: '1s',
      successRate: '83%',
      description: 'Count the number of ways to climb n stairs taking 1 or 2 steps'
    },
    {
      id: 17,
      ...
      timeLimit: '1.5s',
      successRate: '56%',
      description: 'Find all anagrams of a pattern in a string using sliding window'
    },
    {
      id: 18,
    ...
    },
    {
      ...
      timeLimit: '2s',
      successRate: '36%',
      description: 'Transform one word to another through valid dictionary words'
    },
    {
      id: 28,
